...
import ChartPopContent from "./ChartPopContent";
import LineChat from "./LineChat";
import "./PointCount.css";

import PointCard from "./PointCard";
import SalesGrow from "./SalesGrow/SalesGrow";
    ...
    <main>
      ...
      >
        <Row gutter={[24, 24]} justify="space-around">
          <Col className="gutter-row" xs={24} sm={24} md={24} lg={12} xxl={12}>
            <div className="point-count-main" style={{ marginBottom: "50px" }}>
              <Row gutter={[24, 24]}>
                <Col
